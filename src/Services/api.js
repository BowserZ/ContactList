...
// Crear una agenda para ese Usuario
...
export async function getContacts() {
    ...
    try {
      ...
      // Verificar qué contiene `data` y retornar el array de agendas
      if (data && data.agendas) {
        return data.agendas; // Esto debería devolver el array de contactos
      } else {
...
// Actualizar un contacto dentro de una agenda
